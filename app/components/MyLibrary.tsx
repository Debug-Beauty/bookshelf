...
const BookGrid = ({ books, onRemoveFromLibrary, onUpdateBookStatus }: { 
    books: Book[], 
    onRemoveFromLibrary: (bookId: string) => void,
    onUpdateBookStatus: (bookId: string, newStatus: ReadingStatus) => void 
}) => (
                ...
                {allTabs.map(tab => {
                    ...
                    return (
                        <TabsContent key={tab} value={tab}>
                            <BookGrid books={booksForTab} onRemoveFromLibrary={onRemoveFromLibrary} onUpdateBookStatus={onUpdateBookStatus} />
